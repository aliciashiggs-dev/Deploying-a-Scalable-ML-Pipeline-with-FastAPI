...
async def get_root():
    """Say hello!"""
    return {"greeting": "Welcome to the Machine Learning Pipeline API!"}
...
async def post_inference(data: Data):
    ...
    # Process incoming data using loaded encoder with training=False
    ...
    # Predict result using model and processed data
